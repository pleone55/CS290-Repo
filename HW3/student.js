...
function Student(name, major, yearInSchool, club) {
    ...
    this.logMe = function(bool) {
        var str = this.name + ' ' + this.major + ' ' + this.yearInSchool;
        if(bool) {
            str += ' ' + this.club;
        }
        console.log(str);
...
function sortArr(comparator, array) {
    ...
    do {
        ...
        for(var i = 0; i < array.length - 1; i++) {
            if(comparator(copyArray[i], copyArray[i + 1])) {
...
function clubComparator(student1, student2) {
    ...
    var student1Club = clubSelection[student1.club];
    var student2Club = clubSelection[student2.club];

    if(student1Club === undefined) {
        student1Club = 6;
    }
    if(student2Club === undefined) {
        student2Club = 6;
    }

    if(student1Club > student2Club) {
        return true;
    } else if(student1Club < student2Club) {
        return false;
    } else if(student1Club === student2Club) {
...
print(sortArr(yearComparator, students), false);
console.log('\nThe students sorted by major are: ');
print(sortArr(majorComparator, students), false);
console.log('\nThe students sorted by club affiliation are: ');
print(sortArr(clubComparator, students), false);